#ifndef __BIG_INT__HPP
#define __BIG_INT__HPP
...
class bigint{
    ...
    //types
    typedef bigint                      __Myt;
    typedef unsigned long long          __Int;
    typedef signed long long            __SInt;
    typedef std::vector<__Int>          __Data;
    template<bool B, typename T1, typename T2>struct __TypeSelect
    {
        typedef T2 type;
    };
    template<typename T1, typename T2>struct __TypeSelect<true, T1, T2>
    {
        typedef T1 type;
    };
...
public:
    //functions
    bigint():data_{},sign_{} {}  //Cannot be default for "const bigint a;"
    bigint(const __Myt & a) = default;
    bigint(__Myt && a) : data_(std::move(a.data_)), sign_(a.sign_) {}
    bigint(const char* value):data_{},sign_{}
    {
        set(value);
    }
    bigint(const std::string& value):bigint(value.c_str()) {}
    template<typename T>
    bigint(const T & a):data_{},sign_{}
    {
        from(__SupportTypeT<T>(a));
    }

    bigint(bool a):data_{},sign_{}
    {
        a?set("1"):set("0");
    }
    ...
    __Myt operator -()
    {
        return std::move(__Myt(*this).negate());
    }
    //++a;
    __Myt & operator ++()
    {
    ...
    {
        (a < 0 ? shiftRight(-a) : shiftLeft(a));
        return *this;
    }
    //a >>= n;
    __Myt & operator >>=(int a)
    {
        (a < 0 ? shiftLeft(-a) : shiftRight(a));
        return *this;
    }
    //a + b;
    __Myt operator +(const __Myt & a) const
    {
        return std::move(__Myt(*this) += a);
    }
    template<class T>
    __Myt operator +(const T & a) const
    {
        return std::move(__Myt(*this) += a);
    }
    template<class T>
    ...
    __Myt operator +(const char* a) const
    {
        return std::move(__Myt(*this) += bigint(a));
    }
    //a - b;
    __Myt operator -(const __Myt & a) const
    {
    ...
    friend __Myt operator -(const T & a, const __Myt & b)
    {
        return std::move(__Myt(b - a).negate());
    }
    __Myt operator -(const char* a) const
    {
        return std::move(__Myt(*this) -= a);
    ...
    {
        return (sign_ == a.sign_ && data_ == a.data_);
    }
    template<typename T>
    bool operator ==(const T & a) const
    {
        return equal(__SupportTypeT<T>(a));
    }
    //a != b;
    bool operator !=(const __Myt & a) const
    {
    ...
    bool operator <(const __Myt & a) const
    {
        return less(a.sign_, a.data_);
    }
    template<typename T>
    bool operator <(const T & a) const
    {
        return less(__SupportTypeT<T>(a));
    }
    //a > b;
    bool operator >(const __Myt & a) const
    {
    ...
    bool operator >(const T & a) const
    {
        return greater(__SupportTypeT<T>(a));
    }
    //a <= b;
    bool operator <=(const __Myt & a) const
    {
    ...
    std::string toString(int base = 10, bool uppercase = false, bool showbase = false) const
    {
        ...
        {
        case 16:
            return toStringX<4>(kDigits, (showbase ? (uppercase ? "X0" : "x0") : nullptr));
        case 10:
            return toString10();
        case 8:
            return toStringX<3>(kDigits, (showbase ? "0" : nullptr));
        case 2:
            return toStringX<1>(kDigits, (showbase ? (uppercase ? "B0" : "b0") : nullptr));
        default:
            ;
        }
    ...
    {
        return data_.size()?static_cast<long>(data_[0]):0;
    }

    explicit operator unsigned long() const
    {
        return data_.size()?static_cast<unsigned long>(data_[0]):0;
    }

    operator unsigned long long()
    {
        return data_.size()?(data_[0]):0;
    }
    ...
    {
        return data_.size()?static_cast<int>(data_[0]):0;
    }

    explicit operator unsigned int() const
    {
        return data_.size()?static_cast<unsigned int>(data_[0]):0;
    }

    explicit operator short() const
    {
        return data_.size()?static_cast<short>(data_[0]):0;
    }

    explicit operator unsigned short() const
    {
        return data_.size()?static_cast<unsigned short>(data_[0]):0;
    }

    explicit operator char() const
    {
        return data_.size()?static_cast<char>(data_[0]):0;
    }

    explicit operator unsigned char() const
    {
        return data_.size()?static_cast<unsigned char>(data_[0]):0;
    }

    // operator bool() removed (duplicate of explicit operator bool() const above)

    explicit operator float() const
    {
        long double Temp = static_cast<long double>(*this);
        return float(Temp);
    }
    ...
    explicit operator long double() const
    {
        ...
        {
            ret += int(str[i]-'0')*pow(10,length-i);
        }
        return ret*1.0;
    }
    ...
    operator std::string()
    {
        return toString(10, false, true);
    }

    explicit operator char*() const
    {
        return const_cast<char*>(toString(10, false, true).c_str());
    }
    ...
    __Int get(int index) const
    {
        return index<int(data_.size())?data_[index]:0;
    }
    ...
    bigint operator ^=(const __Myt & a)
    {
        if(size()<a.size()) ajust(a.size()-size());
    ...
    template<typename T>
    friend bool operator ^=(const T & a, const __Myt & b)
    {
        return ((__Myt)b).operator ^=(bigint(a));
    }
    ...
    {
        bigint ii(*this);
        unsigned length = ii.data_.size();
        for(unsigned int i = 0; i < length; ++i)
        {
            std::wcout << ii.data_[i] << std::endl;
            ii.data_[i] = ~ii.data_[i];
            std::wcout << ii.data_[i] << std::endl;
        }
        return ii;
    }
...
private:
    ...
    bool set(const char* value)
    {
        ...
        if(success_flag)
        {
            ...
            if(length > 0)
            {
                ...
                //------------------------------------------------------------------
                value = normalize(value,&index,&length);

                for(index = 0; index < length; ++index)
                {
                    if(!::isspace((int)(value[index])))
                    {
                        break;
                    }
                }
                ...
                //----------------------------------------------------------
                //  Use special code for bases 2, 8, 10, and 16.
                //----------------------------------------------------------
    ...
    void zero()
    {
        if(!data_.size()) data_.push_back(0);
        else data_[0] = 0;
        return;
    }

    char* normalize(const char* value,size_t* index,size_t* length)
    {
        //------------------------------------------------------------------
        ...
        if(value[0]=='0')
        {
            for(*index = 0; *index < *length; ++(*index))
            {
                if(value[*index]=='0'&&*index+1<*length&&value[*index+1]!='0')
                {
                    break;
                }
            }
    ...
    {
        reset(a < 0);
        if(a) data_.push_back(abs(a));
    }
    void from(const __Int & a)
    {
        reset();
        if(a) data_.push_back(a);
    }
    void from(const std::string & a)
    {
            ...
            for(bool end = false; !end; toBitsF<1>(data_, p, [&t, &end]
        {
            ...
            for(auto it = t.rbegin(); it != t.rend(); ++it)
                ...
                const auto pos = t.find_last_not_of(char(0)) + 1;
                end = !pos;
                t.erase(pos);
                return c;
            }));
        ...
        default:
            throw std::invalid_argument("Input is not an integer number");
        }
        shrink();
    }
    __Myt & negate()
    ...
    void add(const __Int & a)
    {
        add(false, a);
    }
    void add(const __SInt & a)
    {
        add((a < 0), abs(a));
    }
    ...
    void sub(const __Int & a)
    {
        add(true, a);
    }
    void sub(const __SInt & a)
    {
        add((a > 0), abs(a));
    }
    void sub(const std::string & a)
    {
        *this -= __Myt(a);
    }
    void mul(const __SInt & a)
    {
        mul(abs(a), (a < 0));
    }
    ...
    void mul(bool s, const __Data & a)
    {
        if(mulSign(s, a.empty(), false))
            return;
        __Myt t(*this), r;
        forBits<1>(a, 0, [&r, &t](const __Int & i)
        {
            if(i)
                r += t;
            t <<= 1;
    ...
    void shiftRight(int a)
    {
        ...
        if(!a)
            return;
        __Data r;
        forBits<kEachBits>(data_, a, [&r](const __Int & v)
        {
            r.push_back(v);
        });
        data_.swap(r);
    ...
    bool equal(const __SInt & a) const
    {
        return (sign_ == (a < 0) && 0 == compare(abs(a)));
    }
    bool equal(const __Int & a) const
    {
        return (!sign_ && 0 == compare(a));
    }
    bool equal(const std::string & a) const
    {
        return (*this == __Myt(a));
    }
    bool less(const __Int & a) const
    {
        return less(false, a);
    }
    bool less(const __SInt & a) const
    {
        return less((a < 0), abs(a));
    }
    bool less(const std::string & a) const
    {
        return (*this < __Myt(a));
    }
    template<class T>
    ...
    bool greater(const __Int & a) const
    {
        return greater(false, a);
    }
    bool greater(const __SInt & a) const
    {
        return greater((a < 0), abs(a));
    }
    bool greater(const std::string & a) const
    {
        return (*this > __Myt(a));
    }
    ...
    std::string toStringX(const char * digits, const char * base) const
    {
        ...
        {
            forBits<N>(data_, 0, [&ret, &digits](const __Int & i)
            {
                ret.push_back(digits[i]);
            });
            eraseTailIf(ret, [](__Int c)
            {
                return ('0' == c);
            });
        }
    ...
    {
        std::string ret;
        forBitsReverse<1>(data_, 0, [&ret](const __Int & v)
        {
    ...
    static constexpr __Int getBits(const __Int & val, int from, int bits)
    {
    ...
    template<int N, class F>
    static void toBitsF(__Data & data, int & from, F && func)
    {
        toBits<N>(data, from, func());
    }
    template<int N>
    ...
    static int checkBase(const std::string & a)
    {
        ...
        for(auto c : a)
        {
            switch(r)
            {
                ...
                case 7:
                case 16:
                    r = (('0' <= c && c <= '9') || ('a' <= c && c <= 'f') || ('A' <= c && c <= 'F') ? 16 : -1);
                break;
                default:
                break;
            }
...
template<>struct bigint::__SupportType<std::string>
{
    typedef const std::string & type;
};
template<>struct bigint::__SupportType<const char *>
{
    typedef const std::string & type;
};
template<>struct bigint::__SupportType<char *>
{
    typedef const std::string & type;
};

//template<size_t N>struct bigint::__SupportType<const char [N]>{typedef const std::string & type;};
template<size_t N>struct bigint::__SupportType<char[N]>
{
    typedef const std::string & type;
};

#define __SUPPORT_INTEGER(tp)   \
template<>struct bigint::__SupportType<tp>{ \
...
__SUPPORT_INTEGER(bool);
__SUPPORT_INTEGER(Object);
__SUPPORT_INTEGER(Object*);
__SUPPORT_INTEGER(double);
__SUPPORT_INTEGER(String);
__SUPPORT_INTEGER(Rational);
__SUPPORT_INTEGER(long double);
...
template<typename T>
inline bigint pow(const bigint& a,const T& b){
    if(b == 0) return 1;
...
template<typename T>
inline bigint min(const bigint& a,const T& b){
    return a>b?b:a;
}

template<typename T>
inline bigint max(const bigint& a,const T& b){
    return a>b?a:b;
}
